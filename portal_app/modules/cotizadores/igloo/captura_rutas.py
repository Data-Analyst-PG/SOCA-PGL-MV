...
Captura de rutas con cálculo de utilidades.
Diseño homologado con Lincoln y Set Logis:
  - Sin st.title(), usa section_header() de components
  - Expander de parámetros con título homologado
  - Resultados con kpi_row() + semaforos_ruta() vía mostrar_resultados_utilidad()
"""
...
def render():
    ...
    if revisar:
        ...
        # ── Mostrar resultados con componentes homologados ────────
