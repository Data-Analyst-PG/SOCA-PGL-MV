...
def render():
    ...
    with tab_ver:
        ...
        # Mostrar todas las columnas de la BD excepto auditoría interna e historial JSONB
        cols_excluir = {"historial", "created_at", "updated_at"}
        cols_mostrar = [c for c in df_tabla.columns if c not in cols_excluir]
        st.dataframe(
            df_tabla[cols_mostrar],
            use_container_width=True,
            hide_index=True,
        )
        st.caption(f"**{len(df_tabla)}** rutas mostradas de **{len(df)}** totales.")
        divider()
        st.download_button(
            "📥 Descargar Excel",
            data=_to_excel_bytes(df_tabla[cols_mostrar]),
            ...
            if st.button("💾 Guardar Cambios", key="igloo_confirmar_edicion", type="primary"):
                ...
                nueva_entrada = {
                    ...
                    "cambios_anteriores": {
                        ...
                        "Horas_Termo":          ruta.get("Horas_Termo"),
                        "Costo_Diesel_Camion":  ruta.get("Costo_Diesel_Camion"),
                        "Costo_Diesel_Termo":   ruta.get("Costo_Diesel_Termo"),
                        # Costos operativos fijos
                        "Lavado_Termo":         ruta.get("Lavado_Termo"),
                        "Movimiento_Local":     ruta.get("Movimiento_Local"),
                        "Puntualidad":          ruta.get("Puntualidad"),
                        "Pension":              ruta.get("Pension"),
                        "Estancia":             ruta.get("Estancia"),
                        "Fianza_Termo":         ruta.get("Fianza_Termo"),
                        "Renta_Termo":          ruta.get("Renta_Termo"),
                        # Otros costos (extras)
                        "Pistas_Extra":         ruta.get("Pistas_Extra"),
                        "Cobra_Pistas":         ruta.get("Cobra_Pistas"),
                        "Stop":                 ruta.get("Stop"),
                        "Cobra_Stop":           ruta.get("Cobra_Stop"),
                        "Falso":                ruta.get("Falso"),
                        "Cobra_Falso":          ruta.get("Cobra_Falso"),
                        "Gatas":                ruta.get("Gatas"),
                        "Cobra_Gatas":          ruta.get("Cobra_Gatas"),
                        "Accesorios":           ruta.get("Accesorios"),
                        "Cobra_Accesorios":     ruta.get("Cobra_Accesorios"),
                        "Guias":                ruta.get("Guias"),
                        "Cobra_Guias":          ruta.get("Cobra_Guias"),
                        "Costo_Extras":         ruta.get("Costo_Extras"),
                        # Parámetros de cálculo (para recalcular en el futuro)
                        "Costo Diesel":         ruta.get("Costo Diesel"),
                        "Rendimiento Camion":   ruta.get("Rendimiento Camion"),
                        "Rendimiento Termo":    ruta.get("Rendimiento Termo"),
                        "Modo_Pago_Dom":        ruta.get("Modo_Pago_Dom"),
                        ...
                        "Porcentaje_Utilidad_Bruta": ruta.get("Porcentaje_Utilidad_Bruta"),
                        "Utilidad_Neta":        ruta.get("Utilidad_Neta"),
                        "Porcentaje_Utilidad_Neta":  ruta.get("Porcentaje_Utilidad_Neta"),
                    },
                }
