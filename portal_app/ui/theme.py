...
def aplicar_tema():
    ...
    st.markdown(
        ...
        "color:white!important;background:rgba(204,30,30,0.2)!important;}"
        ...
        "[data-testid='stNavigation'] svg{display:none!important;}"
        "[data-testid='stNavigation'] *{"
        "color:rgba(255,255,255,0.85)!important;}"
        "[data-testid='stNavigation'] [data-testid='stPopover'] *,"
        "[data-testid='stNavigation'] [role='menu'] *,"
        "[data-testid='stNavigation'] [role='listbox'] *,"
        "[data-testid='stNavigation'] ul *,"
        "[data-testid='stNavigation'] ul a{"
        "color:" + PGL_NAVY + "!important;background:white!important;}"
        "[data-testid='stNavigation'] ul a:hover{"
        "color:white!important;background:" + PGL_NAVY + "!important;}"
        "[data-testid='stNavigation'] [aria-selected='true'] *{"
        ...
        "[data-testid='stNavigation'] button,"
        "[data-testid='stNavigation'] [role='button']{"
        "font-size:0.75rem!important;padding:0.65rem 0.7rem!important;min-height:44px!important;}}"
...
def user_header(nombre: str, rol: str = ""):
    ...
    with col_right:
        st.markdown(
            ...
            "color:" + color_texto + ";background:" + color_bg + ";'>"
            + (rol or "usuario") + "</span>"
            "</div></div>",
            unsafe_allow_html=True,
        )
