...
def aplicar_tema():
    ...
    [data-testid="stNavigation"] {
        ...
        padding: 0 1rem;
        border-bottom: 3px solid """ + PGL_RED + """;
    ...
    [data-testid="stNavigation"] a {
        ...
        border-radius: 0 !important; letter-spacing: 0.2px;
        transition: all 0.2s; display: inline-flex !important; white-space: nowrap;
    }
    [data-testid="stNavigation"] a:hover {
        color: white !important; background: rgba(204,30,30,0.18) !important;
    }
    [data-testid="stNavigation"] a[aria-selected="true"] {
        color: white !important;
        border-bottom: 3px solid """ + PGL_RED + """ !important;
        background: rgba(204,30,30,0.12) !important; font-weight: 700 !important;
    }
    ...
    [data-testid="stDataFrame"] { border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(27,34,102,0.06); }
