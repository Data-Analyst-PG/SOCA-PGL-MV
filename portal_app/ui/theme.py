...
# ─────────────────────────────────────────────────────────────────────────────
# Tema global de Palos Garza Logistics
# Contiene: paleta de colores, CSS global responsive, user_header
# ─────────────────────────────────────────────────────────────────────────────
...
def aplicar_tema():
    ...
    @media (max-width: 768px) {{
        ...
        /* KPI grid baja a 2 columnas en móvil */
        .pgl-kpi-grid {{
    ...
    @media (max-width: 480px) {{
        /* KPI grid baja a 1 columna en pantallas muy pequeñas */
        .pgl-kpi-grid {{
            grid-template-columns: 1fr !important;
        }}
    }}
...
def user_header(nombre: str, rol: str = ""):
    ...
    color_texto, color_bg = colores_rol.get(rol.lower(), ("#6B7280", "#F3F4F6"))
